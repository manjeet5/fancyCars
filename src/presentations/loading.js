...
import styles from '../../sass/components/Loading.scss';
export default class Loading extends React.Component {
	...
	render() {
		return (<div className="buffer">
			<svg width="10%" height="100%"  viewBox="0 0 313.3 321.4" >
				<path className="layer1" id="layer" d="M157.1,0c3.8,0,7.9,1.5,11.4,3.2c45.6,21.1,91.2,42.4,136.7,63.8c3.3,1.5,8,2.1,8.1,7c0.1,5-4.7,5.6-7.9,7.1
				...
				<path className="layer2" id="layer" d="M156.6,235c-3.1,0-7.7-1.7-11.3-3.3c-46.5-21.6-93-43.3-139.4-65.1c-2.4-1.1-5.8-4.1-5.6-5.8c0.3-2.4,3.2-5,5.7-6.3
				...
				<path className="layer3"  id="layer" d="M156.8,321.4c-4.6,0-9.3-2.3-13.4-4.2c-45.2-20.9-90.3-42-135.4-63.1c-3.3-1.5-8-2.1-8-7.1c0-5,3.8-5.5,7-7.1
